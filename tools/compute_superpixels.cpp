...
#include "../external/gSLICr/gSLICr_Lib/gSLICr.h"
#include "../external/gSLICr/NVTimer.h"
...
int main(int argc, char* argv[])
{
        ...
        if (argc < 4)
            std::cout << "Usage " << argv[0] << " image_dir image_list out_dir\n";
	...
	my_settings.no_segs = 1000; //1000 superpixels
